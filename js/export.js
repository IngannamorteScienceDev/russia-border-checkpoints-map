...
function cleanProperties(feature) {
  ...
  return {
    ...
    transport_corridor: extra.transportCorridor || props.transport_corridor || "",
    checkpoint_note: extra.checkpointNote || props.checkpoint_note || "",
    near_checkpoint_condition:
      extra.nearCheckpointCondition || props.near_checkpoint_condition || "",
    checkpoint_working_mode_id: extra.workingModeId || props.checkpoint_working_mode_id || "",
    checkpoint_direction_id: extra.directionId || props.checkpoint_direction_id || "",
    branch_name: extra.branchName || props.branch_name || "",
    branch_phone: extra.branchPhone || props.branch_phone || "",
    branch_email: extra.branchEmail || props.branch_email || "",
    branch_address: extra.branchAddress || props.branch_address || "",
    branch_working_time: extra.branchWorkingTime || props.branch_working_time || "",
    branch_slug: extra.branchSlug || props.branch_slug || "",
